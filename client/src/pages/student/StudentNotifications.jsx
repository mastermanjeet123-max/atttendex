...
import { FiBell, FiAlertTriangle, FiInfo, FiCalendar, FiCheckCircle, FiCheck } from 'react-icons/fi';
...
const StudentNotifications = () => {
  ...
  const markAllRead = async () => {
    ...
    setMarkingAll(true);
    try {
      await Promise.all(unread.map(n => api.put(`/student/notifications/${n.id}/read`)));
      ...
      <div className="student-notifications-page">
        <header className="page-header">
          <div>
            ...
            <p>Important updates regarding your attendance and academics</p>
          </div>
          {unreadCount > 0 && (
            <button
          ...
          <div className="notifications-list">
            {notifications.map(notif => (
              ...
              >
                ...
                {!notif.is_read && <div className="unread-dot" title="Click to mark as read" />}
              </GlassCard>
            ))}
          </div>
        )}
